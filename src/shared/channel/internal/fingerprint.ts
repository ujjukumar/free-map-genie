...
export const FINGERPRINT_FULL_LENGTH =
    FINGERPRINT_PREFIX.length + FINGERPRINT_LENGTH;
...
export function isValidFingerprint(
    ...
    return (
        fingerprint.startsWith(FINGERPRINT_PREFIX) &&
        fingerprint.length === FINGERPRINT_FULL_LENGTH
    );
}
